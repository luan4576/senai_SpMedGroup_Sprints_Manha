...
SELECT CRM, NomeMedico, Usuarios.Email, Especialidades.TipoEspecialidade as Especialidade, Clinicas.NomeFantasia, Clinicas.CNPJ, Clinica.RazaoSocial, Enderecos.Cep, Enderecos.Rua Enderecos.Numero
FROM Medicos
...
SELECT NomePaciente, Email, DataNascimento, Telefone, RG, CPF, Enderecos.Rua, Enderecos.Numero, Enderecos.Cidade, Enderecos.Estado, Enderecos.CEP
FROM Prontuarios
INNER JOIN Usuarios ON Prontuarios.IdUsuario = Usuarios.IdUsuario
INNER JOIN Enderecos ON Prontuarios.Endereco = Enderecos.IdEndereco;